...
{
    public class UserTransactionBusinessService : IUserTransactionBusinessService
    {
        ...
        public UserTransactionBusinessService(ILogger<OrderBusinessService> logger,
        ...
        public async Task<Option<(int userId, UserTransaction userTransaction), string>> UpdateUserBalanceAsync(Orders order, ImmutableList<ProductVariants> productVariants, UserTransactionTypeEnum userTransactionType)
        {
